...
# java -jar target/ks-inspector-1.0-SNAPSHOT.jar inspect -b pkc-4yyd6.us-east1.gcp.confluent.cloud:9092 -e KST src/main/cluster-state-tools-data/contexts/example1/instances

java -jar target/ks-inspector-1.0-SNAPSHOT.jar export2Neo4J -b pkc-4yyd6.us-east1.gcp.confluent.cloud:9092 -e KST

# java -jar target/ks-inspector-1.0-SNAPSHOT.jar clearGraph -e KST
